...
<span class="line"><span>Vercel 会自动为你设置持续集成（CI）。每次你将代码推送到指定的 Git 分支时，Vercel 会自动重新构建和部署你的网站。</span></span></code></pre></div><p><a href="https://gaga-space.vercel.app" target="_blank" rel="noreferrer">https://gaga-space.vercel.app</a></p><p>又烂了如何呢</p>`,11)]))}const _=s(l,[["render",i]]);export{g as __pageData,_ as default};
