...
<span class="line"><span>Vercel 会自动为你设置持续集成（CI）。每次你将代码推送到指定的 Git 分支时，Vercel 会自动重新构建和部署你的网站。</span></span></code></pre></div><p><a href="https://gaga-space.vercel.app" target="_blank" rel="noreferrer">https://gaga-space.vercel.app</a></p><p>又烂了如何呢</p><p>ok啊ok啊成功了</p><p>之前打开页面404</p><p>原因是：</p><p>project-settings里面</p><p><img src="`+l+'" alt="alt text"></p>',16)]))}const b=s(t,[["render",i]]);export{_ as __pageData,b as default};
