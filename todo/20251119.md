...
相切 collision + depth=0

碰撞，相交，相切，关系的方位，距离，相交深度


两个物体->有碰撞->找每个碰撞点(方位，相交深度)
->无接触->距离？质心距离？->不需要了

->包含->不写点，方位，距离

->相切 通过增大物体体积-判断碰撞(方位，相交深度减去增大的距离*2)->阈值多少合适
...
```json
{
  "object_A": "bed_01",
  "object_B": "chair_05",
  "relation_types":["collision", "tangency", "contain"],
  "contact_points": [
    {
        "type":"collision或tangency",
        "point": [1.23, 0.88, 0.44],//碰撞点，如果是面算法会自动选择一个点
        "normal": [-0.91, 0.30, 0.01],//碰撞法线
        "depth": 0.026//碰撞深度
    },
    {
        "type":"collision或tangency",
...
```json
{
    "object_A": "0$lAAgJuL088l9rQanHTYp",
    "object_B": "35lVHPvR13xA5LYJ0p4wi6",
    "relation_types": [
      "tangency",
      "contain"
    ],
    "contact_points": [
      {
        ...
        "normal": [
          -0.9999997537090247,
          -4.3710690617150965e-08,
          0.0
        ],//b指向a的方向
        "depth": 0.0004060237109229096
      }
    ],
    "room_id": "32",
    "room_name": "主卫",
